...
var p_app =
{
    ...
    showLoading : function( element )
    {
        ...
        let html     = "<div id='"+ uid +"'  style='position:absolute; z-index:99999; top:"+ top +"px; left:"+ left +"px; width:"+ width +"px; height:"+ height +"px;'>"+
                       "   <div style='top:"+ parseInt( (height/2)-48 ) +"px; left:"+ parseInt( (width/2)-48 ) +"px; position:relative;'>"+
                       "      <span>"+
                       "          <i class='ti ti-loader' style='font-size: 96px; width: 96px; height: 96px; animation: spin 2s linear infinite; transform: rotate(360deg); transform-origin: center;'></i>"+
                       "      </span>"+
                       "   </div>"+
                       "</div>";
