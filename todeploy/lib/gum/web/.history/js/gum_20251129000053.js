...
// TODO: hacerlo -> eliminar los gadgets q usen este device y del gum._aoExEn_
    ...
    _setButtonBar_()
    {
        ...
        const sHTMLBtns = '<i class="gum-mini-btn fa fa-eye"             title="Preview (in new tab)"></i>'+
                          ...
                          '<i class="gum-mini-btn fa fa-code"            title="Dashboard HTML and JavaScript editor"></i>'+
        ...
        $toolbar.find('.fa-code'           ).on( 'click', () => p_app.alert( "Not yet implemented" ) );  // NEXT: implement dashboard code editor
    ...
    _init_ : function( oConfig )
    {
        window.addEventListener('beforeunload', function( evt )
            {
                // Don't need to worry about Dashboard configuration because the changes are saved after closing the dialog

                if( gum.isInDesignMode() && gum._layout_.isChanged() )
                    evt.preventDefault();
            } );
