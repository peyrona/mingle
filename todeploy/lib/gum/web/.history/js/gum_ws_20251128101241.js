...
var gum_ws =
{
    ...
    connect : function( fnOnConnected )
    {
        ...
        let context = this._getContext_( dashboardId );

        if( ! context )
        {
            context = this._createContext_( dashboardId, isDesign, isDesign ? null : tabId );
        }
        else
        {
        ...
        if( isDesign || ! this._getContext_( context.parentContextId ) )
        {
