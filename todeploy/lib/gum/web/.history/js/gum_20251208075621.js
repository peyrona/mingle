...
// TODO: hacerlo -> eliminar los gadgets q usen este device y del gum._aoExEn_
    ...
    _setButtonBar_()
    {
        ...
        const sHTMLBtns = '<i class="gum-mini-btn ti ti-play"          title="Preview (in new tab)"></i>'+
        ...
        $toolbar.find('.ti-play'         ).on( 'click', gum._onPreview_ );
...
// FIXME: --->
        ...
        if( isDesign )
        {
            // Design mode: generate unique dashboard ID
        ...
        {
            // Preview mode: inherit parent dashboard ID from URL parameter
