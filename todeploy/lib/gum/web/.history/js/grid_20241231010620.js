...
var grid =
{
    _KEY_GADGET_  : 'ABCDEF',   // Key used to store a gadget in the 'data' of a widget (a <div>) (Warning: jQuery converts this to camelCase)
    ...
    addGadget : function( gadget )
    {
        ...
        this._lastFocused_.data( this._KEY_GADGET_, gadget )
                        .find('.grid-stack-item-content')
                          .empty()
                          .attr('id', gadget.id )               // By having both same ID things are easier
                          .append( gadget.getContainer() );

        //this._lastFocused_.data( this._KEY_GADGET_, gadget );   // Store the gadget in the widget JS Object

        console.log( this._lastFocused_.data( this._KEY_GADGET_ ) );
    ...
    {
        return $(widget).data( this._KEY_GADGET_ );
