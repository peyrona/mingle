...
class TableEditor
{
     ...
     *
     * @param {Array} aData__ A JSON array containing all table rows and columns.
     * @returns this.
     */
    setData( aData__ )
    {
        ...
        for( let row = 0; row < aData__.length; row++ )
        {
            this._addCells_( this.tbody.insertRow( -1 ), aData__[row] );      // -1 == insert at end of tbody (append)
        }
