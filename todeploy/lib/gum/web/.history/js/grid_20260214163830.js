...
var grid =
{
    ...
    delCard : function()
    {
        ...
        p_app.confirm( "Do you want to delete selected card(s)?", () =>
                        {
    ...
    showHelp : function()
    {
        let sHTML = '<table class="table is-striped">'+
                        ...
                        '<tbody>'+
                            ...
                            '</tr>'+
                            '<tr>'+
                                '<td>Shift-Click</td><td>Add clicked card to the selected ones</td>'+
                            '</tr>'+
                            '<tr>'+
        ...
        if( gum.isInDesignMode() )
        {
            ...
            $('#gum-toolbar').append( $('<br>'+
                                        '<div style="display:flex; justify-content:flex-end; align-items:center;">'+
                                            ...
                                            '<i class="gum-mini-btn ti ti-library-plus" id="grid-btn-addadd" title="Add a new card inside selected one" onclick="grid.addGrid()"  ></i>'+  // FIXME: hacerlo (que un grid se pueda meter dentro de una card)
