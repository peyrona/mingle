...
if( typeof authenticator === "undefined" )
{
    var authenticator =
    {
        ...
        start : function( options )
        {
            ...
            // Forces a logout after the time specified in the server
            $.ajax( {   url     : '/gum/logout',
                        method  : 'GET',
                        error   : (xhr)  => p_app.setSessionTimeout( this._doSessionExpired_ ),
                        success : (secs) => p_app.setSessionTimeout( this._doSessionExpired_ )
                    } );
