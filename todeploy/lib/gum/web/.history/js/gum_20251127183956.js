...
// TODO: hacerlo -> eliminar los gadgets q usen este device y del gum._aoExEn_
    ...
    _setButtonBar_()
    {
        ...
        const sHTMLBtns = '<i class="gum-mini-btn fa fa-eye"             title="Preview (in new tab)"></i>'+
                          ...
                          '<i class="gum-mini-btn fa fa-floppy-o"        title="Save"></i>'+
        ...
        $toolbar.find('.fa-floppy-o'       ).on( 'click', gum._save_() );
    ...
    _save_ : function( fnOnOK = () => {} )
    {
        ...
        const $toolbar = $('#gum-toolbar');
              $toolbar.find('.fa-save').css('color', 'red');
        ...
        $.ajax( {
                    ...
                    success    : () => { gum._layout_.saved(); fnOnOK(); }    // Only on success can be executed this func
                } ).always((xhr, status) =>
                                            {
                                                ...
                                                $toolbar.find('.fa-save').css('color', '');
                                            } );
    },
