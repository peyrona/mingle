...
var grid =
{
    ...
    init : function()
    {
        ...
        $.getScript('/gum/lib/gridstack_v7.2.3.all.js')
         .then(  function()    { grid._onLibLoaded_(); } )
         .catch( function(err) { console.error('Error loading GridStack: ', err ); } );
