        ...
        if( gum.isInDesignMode() )
        {
            ...
            $('#gum-toolbar').append( $('<br>'+
                                        '<div style="display:flex; justify-content:flex-end; align-items:center;">'+
                                            ...
                                            '<i class="gum-mini-btn ti ti-library-plus" id="grid-btn-addadd" title="Add a new card"          onclick="grid.addGrid()"  ></i>'+  // FIXME: hacerlo (que un grid se pueda meter dentro de una card)
