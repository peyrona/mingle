...
class TableEditor
{
    ...
    _refreshButtons_()
    {
        if( this.toolbar !== null )
        {
            ...
            this._setButtonDisabled_( this.this.btnMoveUpId,   (! this.isBtnCloneEnabled ) || (! editable) || noRows );
            this._setButtonDisabled_( this.this.btnMoveDownId, (! this.isBtnCloneEnabled ) || (! editable) || noRows );
