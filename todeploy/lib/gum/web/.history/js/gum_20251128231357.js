...
// TODO: hacerlo -> eliminar los gadgets q usen este device y del gum._aoExEn_
    ...
    _init_ : function( oConfig )
    {
        window.addEventListener('beforeunload', function( evt )
            {
                if( gum.isInDesignMode() && gum._layout_ && gum._layout_.isChanged() )    // Don't need to worry about Dashboard configuration because the changes are saved after closing the dialog
                {
                    evt.preventDefault();
