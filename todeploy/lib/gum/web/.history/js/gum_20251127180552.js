...
// TODO: hacerlo -> eliminar los gadgets q usen este device y del gum._aoExEn_
    ...
    _init_ : function( oConfig )
    {
        if( this.isInDesignMode )
        {
            // To initialice the event manager, it has to be invoked only once.
            //
            ...
            else   // Beacon API not supported. Dashboard changes may be lost when closing the tab or navigating away.
            {
                alert( "Your browser does not support the Beacon API.\n"+
                       "Use a morden browser.\n"+
                       "Dashboards will not be saved." );
            }
        }
