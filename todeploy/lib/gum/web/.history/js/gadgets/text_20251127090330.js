...
class GumText extends GumGadget
{
    constructor( props )
    {
        ...
        // Extract properties from props, with defaults for missing ones

        this.label     = (props && props.label    ) || "This is a fixed text";
        this.align     = (props && props.align    ) || "left";
        this.rows      = (props && props.rows     ) || 1;             // Multi-line text (textarea)?
        this.keep      = (props && props.keep     ) || 0;             // Keep only last N lines (0 == all)
        this.size      = (props && props.size     ) || 100;           // Font size (relative as %)
        this.color     = (props && props.color    ) || "#000000";
        this.bold      = (props && props.bold     ) || false;
        this.italic    = (props && props.italic   ) || false;
        this.underline = (props && props.underline) || false;

        // Must be here -->
        this.width  = (props && props.width)  || 160;
        this.height = (props && props.height) || (this.rows * 22);
    }
