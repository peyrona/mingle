...
class GumGadget
{
    ...
    show(isOngoing = false) {
        ...
        if (this.card_title_location === 'south') {
            ...
            const $centeredTitle = $('<div class="gadget-title gadget-title-center" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 10; text-align: center; padding: 5px;"></div>').html(this.card_title);
