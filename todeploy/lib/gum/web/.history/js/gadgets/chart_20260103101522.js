...
class ChartWrap
{
    ...
    {
        // With time scale, Chart.js positions points based on their timestamp (x value).
        // No need to manage the shared labels array - just return the dot.
        return oDot;
    }
    ...
    _zoom_( event )
    {
        ...
        if( this.chart.options && this.chart.options.scales &&
            this.chart.options.scales.y && this.chart.options.scales.y.title )
        {
