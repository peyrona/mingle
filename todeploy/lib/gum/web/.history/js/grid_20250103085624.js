...
var grid =
{
    ...
    addGadget : function( gadget )
    {
        ...
        this._$focused_.data( this._KEY_GADGET_, gadget )    // Store the gadget in the widget (has to be 1st because 'find(...) crerates a new object)
                       ...
                       .empty()
                       .append( $('<div id="card-title-north" class="card-title" style="display:block;">North Title</div>') )
                       .append( $('<div style="display:block;">').append(gadget.getContainer()) )
                       .append( $('<div id="card-title-south" class="card-title" style="display:block;">South Title</div>') );
