...
if( typeof authenticator === "undefined" )
{
    var authenticator =
    {
        ...
        _getDialogHTML_ : function()
        {
            ...
            return `
                <div style="position:fixed; top:50%; left:50%; transform:translate(-50%,-50%); width:100%; max-width:400px; padding:2rem; border-radius:8px; box-shadow: 0 2px 10px rgba(10, 10, 10, 0.3); background-color:white; z-index:1000;">
