    ...
    var authenticator =
    {
        ...
        _handleLogin_ : function( event )
        {
            ...
            $.ajax( {
                        ...
                        success    : (response) =>
                                    {
                                        $('#auth-dlg-msg').hide();            // In case it was showing the "...session expired..." meesage
        ...
        _doSessionExpired_ : function()
        {
            $.ajax( {
                        ...
                        error   : (xhr) => p_app.showAjaxError( xhr ),
                        success : () => {
                                          $('#auth-dlg-msg').text("Due to inactivity, session expired.<br>You have to login again.", "Session expired").show();
