...
class GumGadget
{
    ...
    show(isOngoing = false)
    {
        ...
        // 6. Append the elements in the correct order.
        if( this.card_title_location === 'south' )
        {
            const $title = $('<div class="gadget-title"></div>').html(this.card_title);
        ...
        else if( this.card_title_location === 'center' )
        {
            ...
            const $centeredTitle = $('<div class="gadget-title-center"></div>').html(this.card_title);
