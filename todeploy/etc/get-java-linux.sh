...
if [ "$ARCH" = "x86_64" ]; then
    ...
    echo "Detected AMD32 (x86) architecture."
    JDK_ARCH="x86"
...
# --- Variables ---
# API URL to get the latest GA (General Availability) release for JDK 11, Linux
JDK_URL="https://api.adoptium.net/v3/binary/latest/11/ga/linux/$JDK_ARCH/jdk/hotspot/normal/eclipse"
